"""
Django settings for forensicPipeline project.
...
SECRET_KEY = 'django-insecure-qa(iqby=8q6u@mtgp5$-pf1d==9k7p!ivnzm!m^rway1i0ux_^'
...
ROOT_URLCONF = 'forensicPipeline.urls'
...
WSGI_APPLICATION = 'forensicPipeline.wsgi.application'
